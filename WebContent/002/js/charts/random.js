function RandomGenerator() { // variables used for random number generators
...
RandomGenerator.prototype._lcg = function() {
...
RandomGenerator.prototype._lcgSetSeed = function(val) {
    // pick a random seed if val is undefined or null
    // the >>> 0 casts the seed to an unsigned 32-bit integer
    this.stateProperty = (val == null ? Math.random() * this.m : val) >>> 0;
};

RandomGenerator.prototype.randomSeed = function(seed) {
...
RandomGenerator.prototype.nextGaussian = function(mean, sd = 1) {
    let y1, x1, x2, w;
